...
class TestArrayList {
	...
	void testArrayList() {
		...
		// esse teste try catch eh equivalente aos testes em baixo com assertThrows
...
//		}
		...
		assertThrows(IndexOutOfBoundsException.class, () -> lista.set(lista.size(), new Aluno(444, "Aluno inválido")));
...
//		} catch (IndexOutOfBoundsException e){}
		...
		assertThrows(IndexOutOfBoundsException.class, () -> lista.set(-1, new Aluno(444, "Aluno inválido")));
